 ...
 * You may try up to 1000000 to speed up  file transfer.
 *
...
#define CUSTOM_MACHINE_NAME "Big Deltabot"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_RADIUS 200 // mm
    // Set the steprate for papertest probing
    #define PROBE_MANUALLY_STEP 0.1 // mm
  #endif

  // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
  #define DELTA_PRINTABLE_RADIUS 225  // mm

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 676.6 // mm
 
  // height from z=0 to home position
  #define DELTA_HEIGHT 887.0 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 294 //mm  Get this value from auto calibrate prev: 218
...
// delta speeds must be the same on xyz
// ORIGINAL SETTINGS #define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_XYZ_STEPS_PER_UNIT (251.97)
...
//#define MKS_12864OLED_SSD1306  // Uses the S1306 controller
