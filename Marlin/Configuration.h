...
#define CUSTOM_MACHINE_NAME "Floor&Eric's Deltabot"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 366.55 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.901, 0.0, -0.376 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 123.23 // mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.153, 0.014, 0.139 } // get these values from auto calibrate
